 ...
 * super("azurekv", operations); this.operations = operations; }
 * 
 * 
 * public String[] getPropertyNames() { String[] list = this.operations.list();
 * return list; }
 * 
 * 
 * public Object getProperty(String name) { Object property =
 * operations.get(name); return property; } }
 */